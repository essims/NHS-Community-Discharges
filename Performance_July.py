# -*- coding: utf-8 -*-
"""
Created on Fri Sep  1 12:04:59 2023
...
best_performers_list = grouped[grouped['performance_group'] == 'The best performers']['Name'].tolist()
medium_performers_list = grouped[grouped['performance_group'] == 'The medium performers']['Name'].tolist()
worst_performers_list = grouped[grouped['performance_group'] == 'The worst performers']['Name'].tolist()
...
performers_df.to_csv('JULY.csv', index=False)