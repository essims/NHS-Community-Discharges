# -*- coding: utf-8 -*-
"""
Created on Tue Aug 22 11:32:31 2023
...
#df.to_csv("Table3-June-1-Org.csv", index=False)
...
old_variable_name1 = 'AC02', 'AE04', 'AG06', 'AI08', 'BA10'
...
old_variable_name2 =  'AD03', 'AF05', 'AH07', 'AJ09', 'BB11'
...
def subtract_seven_days(date, times=1):
    new_date = date
    for _ in range(times):
        new_date -= datetime.timedelta(days=7)
    return new_date
...
previous_date = subtract_seven_days(first_monday, times=1)
result_dates.insert(0,previous_date)
